  ...
  return (
    <div id="main-div" className="w-[386px]">
      ...
      <div id="login-buttons" className="flex justify-between my-5 mx-0">
        ...
        <button className="w-[180px] text-[#858585] text-[12px] font-Montserrat tracking-wider justify-center flex items-center py-2 px-2 font-bold bg-white border-none rounded-md cursor-pointer  transition duration-500">
          <Image
